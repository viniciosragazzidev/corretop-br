...
export const newRoadmapItems: RoadmapItem[] = [
  ...
  item("N6", "Filtros rápidos salvos", "P1", "planned", "Disponibilizar filtros prontos para meus leads, sem contato, estagnados, cotação enviada e documentação pendente.", "Permitir salvar combinações usadas diariamente sem repetir a configuração."),
  item("N7", "Notificações acionáveis", "P1", "planned", "Adicionar prioridade, filtros, agrupamento e destino contextual para cada aviso.", "Toda notificação deve explicar o que aconteceu e qual ação resolve o problema."),
  ...
  item("N11", "Lembretes de retorno", "P1", "planned", "Permitir agendar retornos para hoje, amanhã ou uma data específica diretamente no lead.", "Evitar que oportunidades dependam apenas da memória do corretor."),
