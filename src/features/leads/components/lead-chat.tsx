    ...
    <DialogPopup className="h-[80vh] w-[70vw] max-w-none overflow-hidden p-0 max-lg:w-[86vw] max-sm:h-[88vh] max-sm:w-[calc(100vw-1rem)]" overlayClassName="bg-black/65 backdrop-blur-sm">
      <div className="flex h-full min-h-0 flex-col bg-background">
        ...
        <div className="flex min-h-0 flex-1 flex-col">
          {!active && canSend ? <div className="m-6 rounded-xl border border-border bg-muted/30 p-5 text-sm text-muted-foreground">O seu WhatsApp está desconectado ou o chat interno está desativado. Conecte a sua sessão para enviar mensagens.</div> : <>
