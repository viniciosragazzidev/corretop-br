...
export const MagicWand = createCompatIcon("MagicWand");
...
export const Share = createCompatIcon("Share");
...
export const Megaphone = createCompatIcon("Megaphone");
export const ShareAll = createCompatIcon("ShareAll");
