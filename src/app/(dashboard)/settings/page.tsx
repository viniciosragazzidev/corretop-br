...
export default async function SettingsPage() {
  ...
  const tabIds: TabId[] = context.role === "director" ? ["conta", "empresa", "unidade", "whatsapp", "integracoes", "seguranca"] : context.role === "manager" ? ["conta", "unidade", "whatsapp", "seguranca"] : ["conta", "whatsapp", "seguranca"];
