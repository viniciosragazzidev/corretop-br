...
export default async function LeadDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const interactions = await getLeadTimeline(id);
  ...
  return (
    <>
      ...
      <main className="flex min-h-full flex-col gap-6 bg-background p-4 lg:p-6">
        ...
        <LeadChat active={whatsappConnection?.active ?? true} canAssume={chatCanAssume} canSend={chatCanSend} leadId={lead.id} messages={whatsappMessages} phone={canSeePersonalData ? lead.telefone : null} />
