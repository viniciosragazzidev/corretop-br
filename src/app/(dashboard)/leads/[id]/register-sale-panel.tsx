      ...
      <DialogPopup className="max-h-[min(90vh,44rem)] overflow-y-auto">
        <DialogPanel>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-1.5"><Label htmlFor="approved-value">Valor final aprovado</Label><CurrencyInput id="approved-value" placeholder="0,00" value={approvedValue} onChange={setApprovedValue} /></div>
