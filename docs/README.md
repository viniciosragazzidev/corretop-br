...
| `marketing-vision-implementation-plan.md` | Plano adaptado para a visão de Marketing, escopo por matriz/unidade, permissões e fases de integração | Plano de implementação vigente |
